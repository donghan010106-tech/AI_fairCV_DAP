...
def render_research():
    ...
    <div class="paper-card">
        ...
        <div style="font-size:0.88rem;line-height:1.7;color:#e6edf3;">
            <strong style="color:#38bdf8;">What it is:</strong> Source paper for FairCVdb — introduces the dataset and FairCVtest benchmark framework.<br><br>
            ...
            - Three label conditions: blind (fair), gender-biased, ethnicity-biased<br>
            - Face embeddings (original and SensitiveNets-anonymized) as a multimodal component<br>
            - Defines the 80/20 train/test split (19,200 / 4,800) used in our experiments<br><br>
...
https://doi.org/10.1007/s42979-023-01733-0""", language="text")
    ...
    <div class="paper-card">
        ...
        <div style="font-size:0.88rem;line-height:1.7;color:#e6edf3;">
            <strong style="color:#f43f5e;">What it is:</strong> Primary related work for our fusion comparison study.<br><br>
            ...
            - Limitation: fairness evaluation in the original paper remains relatively limited<br><br>
            ...
            (3) adding Disparate Impact as a third fairness metric, and (4) structuring evaluation around 5 explicit Research Questions.
        </div>
    </div>
    """, unsafe_allow_html=True)

    with st.expander("Citation"):
        st.code("""Swati S, Roy A, Ntoutski E.
...
In: Proceedings of the European Workshop on Algorithmic Fairness (EWAF'24), 2024.""", language="text")
    ...
    <div class="paper-card">
        ...
        <div style="font-size:0.88rem;line-height:1.7;color:#e6edf3;">
            <strong style="color:#22c55e;">What it is:</strong> Benchmark for evaluating demographic bias in AI-based resume screening
            using counterfactual resume pairs targeting LLM-based systems.<br><br>
            <strong style="color:#22c55e;">Key contributions:</strong><br>
            - Counterfactual fairness evaluation: modifies demographic indicators while keeping qualifications identical<br>
            - Reveals racial and gender bias in state-of-the-art LLMs when used for resume evaluation<br>
            - Provides an independent benchmark complementary to FairCVdb<br><br>
...
arXiv:2504.01420, 2025.""", language="text")
    ...
    <tbody>
    <tr><td>Dataset</td><td>FairCVdb (introduced)</td><td>FairCVdb</td><td>FAIRE benchmark</td><td>FairCVdb</td></tr>
    <tr><td>Text Encoding</td><td>None / image features</td><td>Basic text features</td><td>LLM prompting</td><td>SBERT (all-MiniLM-L6-v2)</td></tr>
    <tr><td>Fusion</td><td>Feature concatenation</td><td>Early + Late</td><td>N/A (LLM-based)</td><td>Early + Late + Hybrid</td></tr>
    <tr><td>Fairness Metrics</td><td>DP, EOO</td><td>Limited</td><td>Counterfactual fairness</td><td>DP + EOO + Disparate Impact</td></tr>
    <tr><td>Bias Mitigation</td><td>SensitiveNets face anonymization</td><td>Not addressed</td><td>Not addressed</td><td>3 lightweight techniques (RQ4)</td></tr>
    <tr><td>Research Questions</td><td>None explicit</td><td>Informal</td><td>Bias detection only</td><td>5 explicit RQs (RQ1-RQ5)</td></tr>
    </tbody></table>
    """, unsafe_allow_html=True)
